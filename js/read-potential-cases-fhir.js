...
(async () => {
  ...
  await fs.writeFile("neuromuscular-dysfunction-of-bladder-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("neuromuscular-dysfunction-of-bladder-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
